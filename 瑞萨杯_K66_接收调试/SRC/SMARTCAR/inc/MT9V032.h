...
//--------------------------------------------------------------------------------------------------
#define MT9V032_PCLK                B9                            	//摄像头像素时钟
        
#define MT9V032_VSYNC               E12                            	//摄像头场同步信号
#define MT9V032_VSYNC_CHANNEL       12                              //MT9V032_VSYNC对应引脚的引脚号 PTC6   -->     6
#define MT9V032_INTERRUPT_NUNBERS   PORTE_IRQn                      //中断编号
#define MT9V032_INTERRUPT_ISFR      PORTE->ISFR                     //中断标志位
...
void seekfree_sendimg_032(void);//通过uart0发送图像至上位机
