...
extern uint8_t NRF2401TXBuffer[TX_PLOAD_WIDTH]; //无线发送数组
extern uint8_t NRF2401RXBuffer[RX_PLOAD_WIDTH]; //无线接收数组
...
uint8_t NRF2401_SendData_Duplex(uint8_t *txbuf);//2401双工发送
#endif
