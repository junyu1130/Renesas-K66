...
void CrossProcess(void)
{
    ...
    if(LeftLose<1 && RightLose<1 && AllLose<1
      && ((ABS(LeftEdge[35]  + Width[35] / 2 - MidLine) < 15) || LeftEdge[35] ==MidLine)
      && ((ABS(RightEdge[35] - Width[35] / 2 - MidLine) < 15) || RightEdge[35]==MidLine)
      && ((ABS(LeftEdge[40]  + Width[40] / 2 - MidLine) < 15) || LeftEdge[40] ==MidLine)
      && ((ABS(RightEdge[40] - Width[40] / 2 - MidLine) < 15) || RightEdge[40]==MidLine)
      && ((ABS(LeftEdge[45]  + Width[45] / 2 - MidLine) < 15) || LeftEdge[45] ==MidLine)
      && ((ABS(RightEdge[45] - Width[45] / 2 - MidLine) < 15) || RightEdge[45]==MidLine)
      && ((ABS(LeftEdge[55]  + Width[55] / 2 - MidLine) < 15) || LeftEdge[55] ==MidLine)
      && ((ABS(RightEdge[55] - Width[55] / 2 - MidLine) < 15) || RightEdge[55]==MidLine)
      && (RCross_flag||LCross_flag||LRCross_flag)
      && (controlCnt>=15||LRCross_flag==cross_straight||RCross_flag==cross_straight||LCross_flag==cross_straight))
    {
