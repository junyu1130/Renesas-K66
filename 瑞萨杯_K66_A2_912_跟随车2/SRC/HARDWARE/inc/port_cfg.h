...
//      模块通道        端口          可选范围                建议
#define UART0_RX_PIN    A15        //A1、A15、B16、D6          A1不要用（与Jtag冲突）
#define UART0_TX_PIN    A14        //A2、A14、B17、D7          A2不要用（与Jtag冲突）
...
#define FTM0_CH3_PIN    A6        //C4、A6    
#define FTM0_CH4_PIN    A7        //D4、A7    
