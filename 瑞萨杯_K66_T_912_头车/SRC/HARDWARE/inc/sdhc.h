...
#define SDHCSTA_NOINIT		0x01	//设备未初始化
...
SDHCSTATUS sdhc_initcard_25(void);
SDHCSTATUS sdhc_initcard_40(void);
SDHCRES sdhc_ioc( uint32, void*);
SDHCRES sdhc_readblocks(uint8*, uint32, uint32);
SDHCRES sdhc_writeblocks(uint8*, uint32, uint32);
SDHCRES sdhc_sendcommand(ESDHC_COMMAND_STRUCT_PTR command);//向sd卡发送命令
